...
const defaultFonts: FontDefinition[] = [
  {
    ...
    family: 'Alfacad',
    files: [
      { id: 'alfacad-regular', weight: 400, style: 'normal', format: 'ttf', path: '/fonts/Afacad-Flux-Regular.ttf' },
    ],
    weights: [400],
    styles: ['normal'],
  },
  {
    ...
    family: 'Space Mono',
    files: [
      { id: 'space-mono-regular', weight: 400, style: 'normal', format: 'ttf', path: '/fonts/Space-Mono-Regular.ttf' },
    ],
    weights: [400],
    styles: ['normal'],
  },
