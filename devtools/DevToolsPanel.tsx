...
export function DevToolsPanel() {
  ...
  return (
    ...
    >
      <div
        ref={nodeRef}
        className={`fixed z-[9999] overflow-hidden flex flex-col border border-black ${
          isFullscreen ? 'inset-0' : 'rounded-none shadow-[4px_4px_0_0_var(--color-black)]'
        }`}
        style={{
          ...panelStyles,
          backgroundColor: 'var(--color-neutral-neutral-1)',
        }}
      >
        {/* Header */}
        <WindowTitleBar
          ...
          helpContent={
            <div className="space-y-4">
              <div>
                <h3 className="font-space-mono text-sm uppercase mb-2">Getting Started</h3>
                <p className="font-alfacad text-sm text-black/80">
                  RadTools is a design system development tool that helps you manage components, typography, variables, and assets.
                </p>
              </div>
              <div>
                <h3 className="font-space-mono text-sm uppercase mb-2">Features</h3>
                <ul className="font-alfacad text-sm text-black/80 space-y-1 list-disc list-inside pl-0">
              ...
              <div>
                <h3 className="font-space-mono text-sm uppercase mb-2">Tips</h3>
                <ul className="font-alfacad text-sm text-black/80 space-y-1 list-disc list-inside">
        ...
        <ContextualFooter
          ...
          onAddComponentFolder={async (folderName) => {
            ...
            if (window.__componentsTabAddFolder) {
              await window.__componentsTabAddFolder(folderName);
