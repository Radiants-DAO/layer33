...
export function TypographyStylesDisplay() {
  ...
  const renderStyleRow = (style: TypographyStyle) => {
    ...
    return (
      <div
        key={style.id}
        className="p-4 bg-[var(--color-white)] rounded flex flex-col gap-4 mb-4"
      >
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-alfacad text-sm text-black/60">
              {style.displayName}
            </span>
          </div>
        </div>
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Note about editing */}
      <div className="p-3 bg-green/20 border border-tertiary rounded-sm">
        <p>
