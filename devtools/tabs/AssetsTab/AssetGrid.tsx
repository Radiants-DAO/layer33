  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      {files.map((file) => (
        ...
        >
          {/* Preview */}
          <div className="aspect-square bg-green/20 flex items-center justify-center">
            {file.type === 'image' ? (
              <img
                src={file.path}
                alt={file.name}
          ...
          <button
            ...
            className="absolute top-1 right-1 w-6 h-6 bg-error-red text-white rounded-md opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center"
          >
