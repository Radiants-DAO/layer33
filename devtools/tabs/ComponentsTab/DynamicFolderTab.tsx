  ...
  return (
    <div className="flex flex-col h-full overflow-auto pt-4 pb-4 pl-4 pr-2 bg-[var(--color-white)] border border-black rounded-none space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="font-space-mono text-sm uppercase text-black">{folderName}</h2>
        <Button
          variant="outline"
          size="sm"
          iconName="refresh"
      ...
      {/* Stats */}
      <div className="flex gap-4 font-alfacad text-base text-black/60">
      ...
      {!isLoading && folderComponents.length === 0 && (
        <div className="text-center py-8">
          <p className="text-black/60 font-alfacad text-base mb-2">No components found</p>
          <p className="font-alfacad text-sm text-black/60">
