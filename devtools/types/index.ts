...
// Base Color (brand, neutral, or system primitive)
export interface BaseColor {
  id: string;
  name: string;        // e.g., "sun-yellow", "lightest", "success-green"
  displayName: string; // e.g., "Sun Yellow", "Lightest", "Success Green"
...
export interface FontFile {
  ...
  path: string;              // "/fonts/Afacad-Flux-Regular.ttf"
}

// Font Definition
export interface FontDefinition {
  id: string;
  name: string;              // "Alfacad", "Space Mono"
